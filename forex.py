...
def main():
    ...
    with col1:
        # url = 'https://raw.githubusercontent.com/fredsiika/forex-gpt/main/images/exchange.png
    ...
    with col2:
        st.title('&nbsp; GG\'s ForexGPT')

    with col3:
        badge(type = 'github', name = 'fredsiika/forex-gpt', url = 'https://github.com/fredsiika/forex-gpt')
    ...
    st.markdown('**WIP: Chat Functionality coming soon** ')
